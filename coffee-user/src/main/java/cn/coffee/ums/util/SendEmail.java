...
public class SendEmail {
    //发件人的邮箱和授权码
    private final String myEmailAccount = "1196114709@qq.com";//发送的邮箱
    private final String myEmailPassword = "avwkraptgnxvhhfb";
    ...
    private  String myEmailSMTPServer = "smtp.gmail.com";
...
//        final String smtpPort = "465";
    ...
    public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
        ...
        message.setContent("【验证码】:您的男朋友给您发了爱的验证码，收到请以微信的形式发给他，验证码如下："+info, "text/html;charset=UTF-8");
        // 6. 设置发件时间
    ...
    public static void main(String[] args) {
        ...
        //设置要发送的邮箱
        sendEmail.setReceiveMailAccount("xuedinger3@icloud.com");
        //创建10位发验证码
